  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-block bg-dark bg-opacity-50 rounded">
        ...
        <p id="parrafoCarousel1"> La ODS 14 busca conservar y utilizar sosteniblemente los océanos, mares y recursos marinos.</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-block bg-dark bg-opacity-50 rounded">
        ...
        <p id="parrafoCarousel2">Se busca reducir la contaminación por plásticos y otros desechos que dañan la vida submarina.</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-block bg-dark bg-opacity-50 rounded">
        ...
        <p id="parrafoCarousel3">Una gestión responsable de la pesca es esencial para preservar las especies marinas.</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-block bg-dark bg-opacity-50 rounded">
        ...
        <p id="parrafoCarousel4">La vida submarina es clave para el equilibrio del planeta y necesita ser protegida.</p>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card shadow-sm">
        <div class="card-body" style="padding:10px">
          ...
          <h5 id="tituloEcosistemas" class="card-title">Ecosistemas</h5>
          <p  id="parrafoEcosistemas" class="card-text">Conservación de ecosistemas marinos y costeros para un futuro sostenible.</p>
    </a>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card shadow-sm">
        <div class="card-body" style="padding:10px">
          ...
          <h5 id="tituloContaminacionMarina" class="card-title">Contaminación Marina</h5>
          <p id="parrafoContaminacionMarina" class="card-text">Reducir los desechos marinos, especialmente el plástico.</p>
    </a>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card shadow-sm">
        <div class="card-body" style="padding:10px">
          ...
          <h5 id="tituloPescaSostenible" class="card-title">Pesca Sostenible</h5>
          <p id="parrafoPescaSostenible" class="card-text">Fomentar la pesca responsable y regulada para preservar recursos.</p>
    </a>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card shadow-sm">
        <div class="card-body" style="padding:10px">
          ...
          <h5 id="tituloEducacionOceanica" class="card-title">Educación Oceánica</h5>
          <p id="parrafoEducacionOceanica" class="card-text">Promover la conciencia sobre la importancia de los océanos.</p>
    </a>
        </div>
      </div>
    </div>
